...
function updateProfileModalUI(user) {
    ...
    const menuUsernameSpan = document.getElementById('menu-username'); // NEW: Get the username element from the menu
    ...
    // NEW: Add a class to the username if the user is verified
    if (menuUsernameSpan) {
        if (user.isVerified) {
            menuUsernameSpan.classList.add('verified-username');
        } else {
            menuUsernameSpan.classList.remove('verified-username');
        }
    }
...
function updateProfileModalUILogout() {
    ...
    const avatarUploadInput = document.getElementById('avatar-upload-input');
    const profileDisplayAvatar = document.getElementById('profile-display-avatar');
    const menuUsernameSpan = document.getElementById('menu-username'); // NEW: Get the username element
    ...
    // NEW: Remove the verified-username class on logout
    if (menuUsernameSpan) {
        menuUsernameSpan.classList.remove('verified-username');
    }
